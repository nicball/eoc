...
(define compiler-poly
  (class compiler-gradual
    (inherit
      ...
      pass-build-dominance pass-convert-to-SSA pass-loop-invariant-code-motion pass-local-value-numbering pass-dead-code-elimination pass-convert-from-SSA)
    ...
    (define/override (compiler-passes)
      ...
      `(
        ...
        ("local value numbering"      ,(lambda (x) (pass-local-value-numbering x))      ,interp-Cany-proxy  ,type-check-Cany-proxy)
